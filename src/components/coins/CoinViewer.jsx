...
export default function CoinViewer({
    ...
    useEffect(() => {
        ...
        // Ambient light (soft fill) - bright intensity
        const ambientLight = new THREE.AmbientLight(0xffffff, 1.8);
        scene.add(ambientLight);

        // Main point light (key light for normal map highlights) - bright intensity
        const pointLight = new THREE.PointLight(0xffffff, 6, 100);
        pointLight.position.set(2, 2, 3);
        scene.add(pointLight);

        // Secondary point light (fill) - bright intensity
        const pointLight2 = new THREE.PointLight(new THREE.Color(accentColor), 3, 100);
        pointLight2.position.set(-2, -1, 2);
        scene.add(pointLight2);

        // Rim light - bright intensity
        const rimLight = new THREE.PointLight(0xffffff, 2.5, 100);
